...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-gray-50 dark:bg-[#0B0F17] border-y border-gray-100 dark:border-gray-800 overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            From kickoff to live AI receptionist in under 14 days.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8 relative mb-16">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-3 text-center md:text-left">
                {step.title}
              </h4>
              <p className="text-gray-600 dark:text-gray-400 text-center md:text-left leading-relaxed">
                {step.desc}
              </p>
            </motion.div>
          ))}
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 text-center md:text-left">
              <span className="text-xs font-bold text-brand-600 dark:text-brand-400 uppercase tracking-widest bg-brand-100/50 dark:bg-brand-900/40 px-3 py-1 rounded-full">
                Optional Free Growth Campaign
              </span>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mt-2 mb-2">
                Commission-Based Database Reactivation
              </h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                Tapping your dormant list is the fastest way to generate bookings instantly. We configure your AI platform to reach out to past patients on a 100% risk-free commission basis. We only get paid when patients successfully book and show up for their appointments.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="text-center">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white font-bold px-8 py-4 rounded-full shadow-cta transition-all hover:-translate-y-0.5"
          >
            Create Your Demo Account <ArrowRight className="w-5 h-5" />
          </Link>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            No credit card required. Explore custom setup features instantly.
          </p>
        </div>
      </div>
    </section>
