        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 w-fit shadow-sm"
            >
            ...
            <ul className="space-y-4 mb-8">
              {[
                ...
                "Direct EMR/EHR Booking Integration",
                ...
                <li key={i} className="flex items-start text-gray-700 dark:text-gray-300 font-medium">
                  <CheckCircle2 className="w-5 h-5 text-brand-500 dark:text-brand-400 mr-3 mt-0.5 flex-shrink-0" />
                  {feature}
                </li>
              ))}
            </ul>
          ...
          >
            ...
            <ul className="space-y-4 mb-8">
              {[
                "Sub-60s Response on Web & SMS",
                "Smart Lead Qualification & Scoring",
                "Auto-Routing to Booking Calendar",
                "Conversion-Optimized Clinical Scripts",
              ].map((feature, i) => (
                <li key={i} className="flex items-start text-gray-700 dark:text-gray-300 font-medium">
                  <CheckCircle2 className="w-5 h-5 text-accent-500 dark:text-accent-400 mr-3 mt-0.5 flex-shrink-0" />
                  {feature}
                </li>
              ))}
            </ul>
